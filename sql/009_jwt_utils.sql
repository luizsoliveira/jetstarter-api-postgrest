-- JWT prototype based on: https://github.com/larsar/postgres-jwt-prototype/tree/master
-- JW code based on: https://github.com/michelp/pgjwt
...
--CREATE OR REPLACE FUNCTION jwt.algorithm_sign(signables TEXT, secret TEXT, algorithm TEXT DEFAULT 'HS256')
  RETURNS TEXT LANGUAGE SQL AS $$
WITH
    alg AS (
      SELECT CASE
