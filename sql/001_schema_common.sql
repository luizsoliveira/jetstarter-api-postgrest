CREATE SCHEMA common AUTHORIZATION app_user;

--GRANT ALL on schema common to app_user;

CREATE SEQUENCE common.countries_seq;

CREATE TABLE IF NOT EXISTS common.countries (
  id int NOT NULL DEFAULT NEXTVAL ('common.countries_seq'),
  iso char(2) NOT NULL,
...
GRANT SELECT ON common.countries TO app_user;

--
-- Dumping data for table `countries`
--
INSERT INTO common.countries (id, iso, name, nicename, iso3, numcode, phonecode) VALUES
